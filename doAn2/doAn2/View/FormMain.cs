...
namespace doAn2
{
    public partial class FormMain : Form
    {
        ...
        private void cậpNhậtGiáoViênToolStripMenuItem_Click(object sender, EventArgs e)
        {
            //MoNut(sender, RGBMau.color2);
            FormGiaoVien frm = new FormGiaoVien();
            MoForm(frm);
        ...
        private void quảnLýThểLoạiVàTàiKhoảnToolStripMenuItem_Click(object sender, EventArgs e)
        {
            FormCaiDat frm = new FormCaiDat(this, panel1, panel2);
            MoForm(frm);
        }
        ...
        private void thốngKêCôngNợToolStripMenuItem_Click(object sender, EventArgs e)
        {
            BaoCaoLuong frm = new BaoCaoLuong();
            frm.ShowDialog();
        }

        private void quảnLýChiTiếtLớpToolStripMenuItem_Click(object sender, EventArgs e)
        {
            FormChiTietLopHoc frm = new FormChiTietLopHoc();
            MoForm(frm);
        }
